      ...
      <div className="flex flex-wrap gap-2">
        {tips.map((tip) => {
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`inline-flex items-center justify-center text-center px-3 py-2 rounded-full text-xs font-medium transition-all duration-300 gradient-animated ${
              theme === 'dark'
                ? isSelected
